...
sudo apt install -y python3-rosdep python3-rosinstall python3-rosinstall-generator python3-wstool build-essential python3-rosdep pytohn3-pip python3-vcstool
...
export GAZEBO_MODEL_PATH=~/UrbanFireRobot/ros2_ws/install/warehouse_simulation/share/warehouse_simulation/models